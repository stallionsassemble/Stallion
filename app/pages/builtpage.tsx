    ...
    return(
        <div className="py-28 w-full">
            <div className="flex flex-col items-center gap-12">
                <div className="font-[Drukwide] font-500  uppercase text-[60px] text-[#37474F]">Built for you</div>
                <div className="font-[Drukwide] text-center w-1/2 leading-[40px] tracking-wide text-[13px]">We’re not just building a platform we’re forging a community. 
            ...
            <div className="relative">
                <div className=" justify-around gap-32 flex items-center">
                    ...
                    <Button variant="stallion" className="px-16 flex-end absolute top-[20%]">Join Waitlist</Button>
